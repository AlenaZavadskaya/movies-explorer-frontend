      ...
      <div className="about-me__info">
        <div className="about-me__text">
          ...
          <p className="about-me__background">
            ...
            <br />
            Увлекаюсь музыкой и плаванием.
            <br /> После нескольких лет работы по специальности друзья
            вдохновили меня на изучение программирования.
            <br />
            Так я прошла обучение в Яндекс.Практикум и хочу дальше связать свою
            жизнь с веб-разработкой.
          </p>
